...
__decorate([
    (0, swagger_1.ApiProperty)({ description: "Unique identifier of the address" }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: "Country", nullable: true }),
    (0, typeorm_1.Column)({ nullable: true }),
    __metadata("design:type", String)
], Address.prototype, "country", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ type: () => person_entity_1.Person, description: "Associated person" }),
    (0, typeorm_1.ManyToOne)(() => person_entity_1.Person, (person) => person.addresses, {
        onDelete: "CASCADE",
    }),
