...
let Phone = exports.Phone = class Phone {
};
__decorate([
    (0, swagger_1.ApiProperty)({ description: "Unique identifier of the phone number" }),
...
__decorate([
    ...
    (0, typeorm_1.ManyToOne)(() => person_entity_1.Person, (person) => person.phones, { onDelete: "CASCADE" }),
